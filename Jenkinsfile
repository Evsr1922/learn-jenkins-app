pipeline {
    ...
    stages {
        ...
        stage('stage E2E') {
            ...
            post {
                always {
                    publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'playwright-report1', reportFiles: 'index.html', reportName: 'Playwright E2E1', reportTitles: '', useWrapperFileDirectly: true])
                }
            }
        }
        stage ('Approval') {
